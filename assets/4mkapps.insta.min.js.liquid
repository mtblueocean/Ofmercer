        ...
        Insta: function () {
            ...
            FourMKApps.perform4MK('#insta-carousel', 'images', function (ele, t) {
                ...
                $(t.Images).each(function (index, img) {
                    ...
                    imgElem.width = '{{settings.insta_car_height}}';
                    imgElem.height = '{{settings.insta_car_height}}';
                    $(imgElem). //css('border', '1px solid #ccc').
                    css('background-color', 'white').
                    css('padding', '{{settings.insta_car_padding}}').
                    css('margin', '{{settings.insta_car_margin}}').
                    css('margin-left', '0px').
                    css('display', 'block').
                    css('float', 'left').
                    css('width', '{{settings.insta_car_width}}').
                    css('height', '{{settings.insta_car_height}}').
                    css('cursor', 'pointer');
